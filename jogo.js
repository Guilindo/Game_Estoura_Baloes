var timerId = null;  /* variavel que armazena a chamada da funcao timout */
...
function contagem_tempo(segundos){
  ...
  if(segundos == -1){
    clearTimeout(timerId); /* para executacao da funcao do settimeout */
    game_over();
    return false
  }
...
function situacao_jogo(baloes_inteiros){
    if(baloes_inteiros == 0) {
        alert('Parabens, voce conseguir estourar todos os baloes a tempo');
        parar_jogo();
    }
